...
local Tab7 = FlurioreGui:CreateTab({
    ["Name"] = "Raid",
    ["Icon"] = ""
})
local Tab8 = FlurioreGui:CreateTab({
    ["Name"] = "Race V4",
    ["Icon"] = ""
})
local Tab9 = FlurioreGui:CreateTab({
    ["Name"] = "Shop",
    ["Icon"] = ""
})
local Tab10 = FlurioreGui:CreateTab({
    ["Name"] = "Misc",
    ["Icon"] = ""
})
local Tab11 = FlurioreGui:CreateTab({
    ["Name"] = "Hop",
    ["Icon"] = ""
})
local Tab12 = FlurioreGui:CreateTab({
    ["Name"] = "Discord",
    ["Icon"] = ""
})
-------------------------------------------------------------------------------------------------------------------------------------------
...
local Dropdown = Section:AddDropdown("DropdownDelayAttack", {
	["Title"] = "Select Fast Attack",
	["Content"] = "Chọn Tốc Độ Đánh",
	["Multi"] = false,
